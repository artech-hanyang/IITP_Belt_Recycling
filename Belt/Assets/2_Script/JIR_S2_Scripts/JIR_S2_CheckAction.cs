...
public class JIR_S2_CheckAction : MonoBehaviour
{
    ...
    JIR_S2_GetRawData ir_s2_raw_data;
    ...
    private void Awake()
    {
        ir_s2_raw_data = GameObject.Find("DataManager").GetComponent<JIR_S2_GetRawData>();
    ...
    private void OnTriggerEnter(Collider other)
    {
        if (other.gameObject.name.Contains("Item"))
        {
            ...
            S2_User_Log.Log("User", "Get", other.gameObject.tag.ToString(), "", "", "", "", "", "", "", "", "", "", "");
    ...
    private void OnTriggerStay(Collider other)
    {
        ...
        if (other.gameObject.name.Contains("Item"))
        {
            ...
            tempLeft_ControllorPos.x += Mathf.Abs(ir_s2_raw_data.left_ControllorPos.x);
            tempLeft_ControllorPos.y += Mathf.Abs(ir_s2_raw_data.left_ControllorPos.y);
            tempLeft_ControllorPos.z += Mathf.Abs(ir_s2_raw_data.left_ControllorPos.z);

            tempRight_ControllorPos.x += Mathf.Abs(ir_s2_raw_data.right_ControllerPos.x);
            tempRight_ControllorPos.y += Mathf.Abs(ir_s2_raw_data.right_ControllerPos.y);
            tempRight_ControllorPos.z += Mathf.Abs(ir_s2_raw_data.right_ControllerPos.z);
    ...
    private void OnTriggerExit(Collider other)
    {
        if (other.gameObject.name.Contains("Item"))
        {
            ...
            S2_User_Log.Log("User", "Drop", other.gameObject.tag.ToString(), ir_yellowCheck.totHandHesitation.ToString(),
