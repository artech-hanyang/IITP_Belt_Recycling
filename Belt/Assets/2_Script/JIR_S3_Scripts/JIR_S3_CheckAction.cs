...
public class JIR_S3_CheckAction : MonoBehaviour
{
    ...
    JIR_S3_GetRawData ir_s3_raw_data;
    ...
    private void Awake()
    {
        ir_s3_raw_data = GameObject.Find("DataManager").GetComponent<JIR_S3_GetRawData>();
    ...
    private void OnTriggerStay(Collider other)
    {
        ...
        if (other.gameObject.name.Contains("Item"))
        {
            ...
            tempLeft_ControllorPos.x += Mathf.Abs(ir_s3_raw_data.left_ControllorPos.x);
            tempLeft_ControllorPos.y += Mathf.Abs(ir_s3_raw_data.left_ControllorPos.y);
            tempLeft_ControllorPos.z += Mathf.Abs(ir_s3_raw_data.left_ControllorPos.z);

            tempRight_ControllorPos.x += Mathf.Abs(ir_s3_raw_data.right_ControllerPos.x);
            tempRight_ControllorPos.y += Mathf.Abs(ir_s3_raw_data.right_ControllerPos.y);
            tempRight_ControllorPos.z += Mathf.Abs(ir_s3_raw_data.right_ControllerPos.z);
