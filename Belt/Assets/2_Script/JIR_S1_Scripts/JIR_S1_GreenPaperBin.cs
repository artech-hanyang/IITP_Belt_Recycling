...
public class JIR_S1_GreenPaperBin : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.gameObject.name.Contains("Item"))
        {
            ...
            S1_User_Log.Log("System", "Get", other.gameObject.tag.ToString(), "", "", "", "", response, interferenceResponse.ToString(), "", "", "", incorrect.ToString(), correct.ToString());
